...
dependencies {
    ...
    // آپدیت کردن BOM به نسخه جدید برای حل ارور SwipeToDismissBox و توابع جدید
    ...
    // آپدیت نویگیشن برای حل ارورهای navArgument و NavType
